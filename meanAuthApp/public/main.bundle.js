...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessage.show('You have logged out successfully!', { cssClass: 'alert-success', timeout: 3000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('Please give a valid email...', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        //Register user
        //observable so need to subscribe
